...
def is_palindrome(n):
    #pass
    # Reverse the integer
    return str(n) == str(n)[::-1]#yeh sbse phle string me no. ko convert krega ,fr use reverse krke,
    #check krega ,age dono same hue to true return hoga else false return hoga

if __name__ == "__main__":
    n = int(input("Enter the number of test cases\n")) # Take number of test cases
    numbers = []
    for i in range(n):# Run to the number of cases
